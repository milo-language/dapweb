...
// Needs dapweb-web on [port] targeting /tmp/dapweb_threads:
//   clang -g -O0 examples/threads.c -o /tmp/dapweb_threads   (compile from repo; DWARF points at examples/threads.c)
//   ./dapweb web --program /tmp/dapweb_threads --port 8093
