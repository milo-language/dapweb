...
// (disassemble). Speaks WS protocol v2 like tests/e2e.ts; needs a dapweb-web on
// [port] targeting /tmp/dapweb_inter. Runs two debug sessions on one WS
...
ok(stopped.frames[0].path?.endsWith("dapweb_inter.c"), "frame0 has source path", stopped.frames[0]);
